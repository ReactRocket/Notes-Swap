...
<body>
  <div id="sidebar">
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="viewProfile.php" >Subject</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="viewProfile.php" >Certificate Courses</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white" href="viewProfile.php" >Assignment</a>
      </li>
    </ul>
  </div>
  <div id="content">
